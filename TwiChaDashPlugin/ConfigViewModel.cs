...
namespace TwiChaDashPlugin
{
    class ConfigViewModel : ViewModelBase
    {
        ...
        {
            get { return _options.TwiChaDashPath; }
            set { _options.TwiChaDashPath = value; }
        }
        ...
        public bool IsExecTwiChaDashAtBoot
        {
            get { return _options.IsExecTwiChaDashAtBoot; }
            set { _options.IsExecTwiChaDashAtBoot = value; }
        }
        public bool IsKillTwiChaDash
        {
            get { return _options.IsKillTwiChaDash; }
            set { _options.IsKillTwiChaDash = value; }
        }

        public int TwiChaDashPort
        {
            get { return _options.TwiChaDashPort; }
            set { _options.TwiChaDashPort = value; }
        }
        public string TwiChaDashIP
        {
            get { return _options.TwiChaDashIP; }
            set { _options.TwiChaDashIP = value; }
        }
        ...
        private void ShowFilePicker()
        {
            try
            {
                ...
                {
                    Title = "TwiChaDashの実行ファイル（TwiChaDash.exe）を選択してください",
                    Filter = "TwiChaDash | TwiChaDash.exe"
                };
            ...
            _options.PropertyChanged += (s, e) =>
            {
                switch (e.PropertyName)
                {
                    case nameof(_options.IsEnabled):
                        ...
                        break;
                    case nameof(_options.TwiChaDashPath):
                    ...
                    case nameof(_options.IsReadComment):
                        ...
                        break;
                    case nameof(_options.TwiChaDashIP):
                        RaisePropertyChanged(nameof(TwiChaDashIP));
                        break;
                    case nameof(_options.TwiChaDashPort):
                        RaisePropertyChanged(nameof(TwiChaDashPort));
                        break;
                }
            };
