...
namespace TwiChaDashPlugin
{
    class Options : DynamicOptionsBase
    {
        ...
        public string TwiChaDashPath { get { return GetValue(); } set { SetValue(value); } }
        ...
        public bool IsExecTwiChaDashAtBoot { get { return GetValue(); } set { SetValue(value); } }
        public bool IsKillTwiChaDash { get { return GetValue(); } set { SetValue(value); } }
        public int  TwiChaDashPort { get { return GetValue(); } set { SetValue(value); } }
        public string TwiChaDashIP { get { return GetValue(); } set { SetValue(value); } }
        ...
        protected override void Init()
        {
            ...
            Dict.Add(nameof(TwiChaDashPath), new Item { DefaultValue = "", Predicate = s => true, Serializer = s => s, Deserializer = s => s });
            ...
            Dict.Add(nameof(IsExecTwiChaDashAtBoot), new Item { DefaultValue = false, Predicate = b => true, Serializer = b => b.ToString(), Deserializer = s => bool.Parse(s) });
            Dict.Add(nameof(IsKillTwiChaDash), new Item { DefaultValue = false, Predicate = b => true, Serializer = b => b.ToString(), Deserializer = s => bool.Parse(s) });
            Dict.Add(nameof(TwiChaDashPort), new Item { DefaultValue = 51200, Predicate = b => true, Serializer = b => b.ToString(), Deserializer = s => int.Parse(s) });
            Dict.Add(nameof(TwiChaDashIP), new Item { DefaultValue = "127.0.0.1", Predicate = n => true, Serializer = n => n.ToString(), Deserializer = s => s });
